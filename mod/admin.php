...
function admin_page_users_post(App $a)
{
	...
	$nu_lang     = defaults($_POST, 'new_user_lang'    , '');
	...
	// $l10n = $nu_lang;
	file_exists('view/lang/'.$nu_lang.'/admin_invite_email.md')
	? $el10n = $nu_lang
	: $el10n = 'en-us';
	...
	if (!($nu_name === "") && !($nu_email === "") && !($nu_nickname === "")) {
		...
		$user = $result['user'];
		$body = Strings::deindent(file_get_contents('view/lang/'.$el10n.'/admin_invite_email.md'));
		L10n::pushLang($nu_lang);
...
function admin_page_users(App $a)
{
	...
	$o = Renderer::replaceMacros($t, [
		...
		'deleted' => $deleted,
		'$users' => $users,
		'$newuserlang' => ['new_user_lang', L10n::t("Language"), 'de', L10n::t("Language of the new user"), L10n::getAvailableLanguages()],
